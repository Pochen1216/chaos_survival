...
execute as @a[scores={cc_iron=1..}] run xp add @s 1 points
execute as @a[scores={cc_gold=1..}] run xp add @s 1 points
execute as @a[scores={cc_copper=1..}] run xp add @s 1 points
