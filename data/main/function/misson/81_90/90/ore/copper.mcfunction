...
tellraw @s ["",{"text":"[\u4efb\u52d9]","color":"aqua"},{"text":"\u4f60\u4e0a\u7e73\u4e86","color":"white"},{"text":" ","color":"green"},{"score":{"name":"@s","objective":"ore_count"},"color":"green"},{"text":" 個蜘蛛網","color":"white"},{"text":"\uff0c\u56e0\u6b64\u7372\u5f97 ","color":"white"},{"score":{"name":"@s","objective":"temp5"},"color":"green"},{"text":" \u5206\uff0c\u5408\u8a08\u7372\u5f97 ","color":"white"},{"score":{"name":"@s","objective":"point"},"color":"gold"},{"text":" \u5206","color":"white"}]
