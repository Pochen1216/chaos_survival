...
execute as @a[team=!spec] at @s run summon minecraft:wither ~ ~ ~ {Tags:[misson],Invul:100,Health:20}
execute as @a[team=!spec] at @s run attribute @e[type=minecraft:wither,limit=1,sort=nearest] minecraft:max_health base set 20
