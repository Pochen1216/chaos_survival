...
execute as @a run scoreboard players operation temp temp2 > @s armor_value
...
execute as @a run tellraw @a ["",{"text":"[\u4efb\u52d9]","color":"aqua"},{"selector":"@s","color":"dark_green"},{"text":"\u7684\u76d4\u7532\u503c: ","color":"white"},{"score":{"name":"@s","objective":"armor_value"},"color":"gold"}]
