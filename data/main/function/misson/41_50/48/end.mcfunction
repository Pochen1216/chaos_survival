...
execute if entity @a[scores={break_nsword=0}] run tellraw @a ["",{"text":"[\u4efb\u52d9]","color":"aqua"},{"text":"\u7531\u65bc","color":"white"},{"selector":"@a[scores={break_nsword=0}]","color":"dark_green"},{"text":"\u672a\u4f7f\u7528\u795e\u528d\uff0c\u56e0\u6b64\u906d\u5230\u4e86\u5236\u88c1!","color":"white"},{"text":"\n "}]
