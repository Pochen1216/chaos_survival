...
execute as @a store success score @s detect_circle run clear @s minecraft:ender_pearl 0
...
execute as @a store success score @s detect_circle run clear @s minecraft:snowball 0
...
schedule function main:misson/41_50/42/tick 1t
