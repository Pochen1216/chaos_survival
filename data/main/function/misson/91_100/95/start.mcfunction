...
title @a title [{"text":"異端審判","color":"white"}]
execute as @a at @s run playsound minecraft:entity.arrow.hit_player


#[任務]附近生成了一隻女巫，率先擊殺得分!
tellraw @a ["",{"text":"[\u4efb\u52d9]","color":"aqua"},{"text":"附近生成了一隻女巫，率先擊殺得分!","color":"white"}]
...
advancement revoke @a only main:misson/95
tag @a add misson95

execute as @a[team=!spec] at @s run summon witch ~ ~ ~ {Tags:[misson]}
#execute as @a[team=!spec] at @s run spreadplayers ~ ~ 0 3 true @e[type=witch,limit=1,sort=nearest]



schedule function main:misson/91_100/95/tick 5t
