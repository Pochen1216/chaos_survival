...
tellraw @a [{"text":"[系統]","color":"light_purple"},{text:"探索到了骷髏!小心周圍!",color:white}]
...
scoreboard players add skeleton temp100 1
execute if score skeleton temp100 matches 2.. run tellraw @a [{"text":"[系統]","color":"light_purple"},{text:"所有玩家被骷髏殺死，現在開始結算....",color:white}]
execute if score skeleton temp100 matches 1 as @a[team=100_g] at @s run summon skeleton
execute if score skeleton temp100 matches 2 as @a[team=100_g] at @s run summon skeleton
execute if score skeleton temp100 matches 2 as @a[team=100_g] at @s run summon skeleton
execute if score skeleton temp100 matches 2 as @a[team=100_g] at @s run summon skeleton
execute if score skeleton temp100 matches 2 as @a[team=100_g] at @s run summon skeleton
execute if score skeleton temp100 matches 2 as @a[team=100_g] at @s run summon skeleton
execute if score skeleton temp100 matches 2 as @a[team=100_g] at @s run summon skeleton
execute if score skeleton temp100 matches 2 as @a[team=100_g] at @s run summon skeleton
execute if score skeleton temp100 matches 2.. run scoreboard players set @a[team=100_g] m100_pl_jam 0
execute if score skeleton temp100 matches 2.. run schedule function main:misson/91_100/100/end 60t
execute if score skeleton temp100 matches 2.. run return 0
