...
title @a title [{"text":"旋轉跳躍","color":"white"}]
execute as @a at @s run playsound minecraft:entity.arrow.hit_player


#[任務]已生成旋風使者，先擊殺的人加一分!
tellraw @a ["",{"text":"[\u4efb\u52d9]","color":"aqua"},{"text":"已生成旋風使者，先擊殺的人加一分!","color":"white"}]
...
advancement revoke @a only main:misson/56
tag @a add misson56

execute as @a[team=!spec] at @s run summon breeze ~ ~ ~ {Tags:[misson]}
