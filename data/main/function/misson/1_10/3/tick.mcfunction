...
execute as @a[team=!spec,scores={item_count=0}] run tag @s add win
execute if entity @a[team=!spec,scores={item_count=0}] run function main:misson/1_10/3/end
execute if entity @a[team=!spec,scores={item_count=0}] run return 0
